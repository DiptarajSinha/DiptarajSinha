      ...
      >
        ...
        >
          ...
          <div className="flex flex-col md:flex-row h-full max-h-[85vh]">
            ...
            <div className="w-full md:w-1/2 relative h-64 md:h-auto bg-black flex items-center justify-center border-b md:border-b-0 md:border-r border-yellow-900/20 overflow-hidden">
              <Image 
